...
<div class="container">
    <h2>Water Counter Informations</h2>
    <p>
<div class="table-box">
    ...
    <table>
        ...
        <?php    
include 'conn.php';
$sel=mysqli_query($con,"SELECT * FROM water_counter");
while ($row=mysqli_fetch_array($sel)) {
   ...
   echo "<td>".$row[2]."</td>";
     echo "<td>
          <a href='editwater.php?a=".$row[0]."&b=".$row[1]."&c=".$row[2]."' class='btn-edit'>Edit</a>
          <a href='deletewater.php?id=".$row[0]."' class='btn-delete'>Delete</a>
        </td>";
  echo "</tr>";
